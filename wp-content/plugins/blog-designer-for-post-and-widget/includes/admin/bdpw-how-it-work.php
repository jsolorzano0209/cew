...
function bdpw_help_tabs() {
	$wpos_feed_tabs = array(
						...
						'offers-feed' 	=> array(
													'name'				=> __('Hire Us', 'blog-designer-for-post-and-widget'),
								...
								<div class="inside">
									<table class="form-table">
										<tbody>
											<tr>
												<th>
													<label><?php _e('Geeting Started', 'blog-designer-for-post-and-widget'); ?></label>
												</th>
												<td>
													<ul>
											...
											<tr>
												...
												<td>
													...
													<a class="button button-primary" href="http://docs.wponlinesupport.com/blog-designer-post-and-widget/" target="_blank"><?php _e('Documentation', 'blog-designer-for-post-and-widget'); ?></a>									
													<a class="button button-primary" href="http://demo.wponlinesupport.com/blog-designer-post-and-widget/" target="_blank"><?php _e('Demo for Designs', 'blog-designer-for-post-and-widget'); ?></a>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
								...
								<div class="inside">										
									...
									<a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wp-plugin/blog-designer-post-and-widget/" target="_blank"><?php _e('Go Premium ', 'blog-designer-for-post-and-widget'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/blog-designer-post-and-widget/" target="_blank"><?php _e('View PRO Demo ', 'blog-designer-for-post-and-widget'); ?></a>			</p>								
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
					...
					<div class="metabox-holder">
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
									...
									<div class="inside">										
										<p>Enjoyed this plugin? You can help by rate this plugin <a href="https://wordpress.org/support/plugin/blog-designer-for-post-and-widget/reviews/" target="_blank">5 stars!</a></p>
									</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->

...
?>
	...
	<?php wp_editor(wp_specialchars_decode($post->post_excerpt), 'excerpt', array('media_buttons' => false, 'quicktags' => false, 'editor_height' => 150) ); ?>
	<p class="description">
...
function mbt_buybuttons_metabox_editor($data, $num, $store) {
	...
	$output .= '<button class="mbt_buybutton_remover button">'.__('Remove', 'mybooktable').'</button>';

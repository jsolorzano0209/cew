...
function mbt_seo_title($post_id = 0) {
	...
	if($post) {
		...
		if(empty($seo_title)) {
			...
			$template_fix = (($template === "twentyten" or $template === "twentyeleven") ? " " : "");
		...
		<tbody>
			<tr>
				...
				<td>
					...
					<p><?php printf(__('Title display in search engines is limited to 70 characters, %s characters left.', 'mybooktable'), '<span id="mbt_seo_title-length">70</span>'); ?></p>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<p><?php printf(__('The meta description will be limited to 156 characters, %s characters left.', 'mybooktable'), '<span id="mbt_seo_metadesc-length">156</span>'); ?></p>
				</td>
			</tr>
		</tbody>
	</table>

...
function mbt_render_sort_books_page() {
	...
	function mbt_add_book_sorting_attribute(attribute) {
		...
		var attributes = {
			'title': mbt_admin_pages_i18n.post_title,
			'date': mbt_admin_pages_i18n.post_date,
			'author': mbt_admin_pages_i18n.author,
			'genre': mbt_admin_pages_i18n.genre,
			'tag': mbt_admin_pages_i18n.tag,
			'series': mbt_admin_pages_i18n.series,
			'series_order': mbt_admin_pages_i18n.series_order,
		};
		...
		element += '<option value="asc" '+(attrib_dir === 'asc' ? 'selected="selected"' : '')+'>'+mbt_admin_pages_i18n.ascending+'</option>';
		element += '<option value="desc" '+(attrib_dir === 'desc' ? 'selected="selected"' : '')+'>'+mbt_admin_pages_i18n.descending+'</option>';
		element += '</select>';
		if(jQuery('.mbt_book_attribute').length >= 1) {

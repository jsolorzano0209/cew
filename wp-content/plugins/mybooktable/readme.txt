...
= 3.1.4 =
* Fixed an issue with Divi theme integration that was preventing detection of the theme in certain cases
* Fixed an issue that sometimes prevented proper scrolling on shadow box popup on IOS devices

= 3.1.3 =
* Fixed bug causing new book blurb editor to not save html tags properly
* Removed taxonomy titles from book archive pages by default

= 3.1.2 =
* Update MyBookTable translation files, fixing issues with certain strings not getting translated properly
* Added basic integration with Divi theme to improve display quality
* Added WYSIWYG editor support for book blurbs
* Fixed various minor bugs and typos

= 3.1.1 =
* Improved display for "Twenty Seventeen" theme
* Fixed a bug that caused the Order Now button to not function with certain themes.
* Fixed a bug that prevented the Featured Book Widget from working in Live Preview mode.
* Fixed a bug that caused warnings to be displayed with certain server configurations.

= 3.1.0 =
* Added Universal Buy Button.
* Added Audio Book Resources metabox to book pages.
* Improved search from Buy Button editor functionality to automatically search for book title.
* Added Powell's affiliates integration.
* Added IndieBound affiliates integration.
* Book pages can now be selected as the front page of your website via Reading settings.
* Various CSS styling improvements.

= 3.0.9 =
* Added Czech, Spanish, and Russian translations.
* Fixed an issue with French translation that caused JavaScript errors.
* Fixed an issue with the "Order Now" button showing up when no Buy Buttons were enabled.
* Added title filters for Overview sections.
...
= 1.3.6 =
* Added official WordPress 4.0 compatibility
...
* Fixed potential style compatibility issues with some themes

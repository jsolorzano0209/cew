...
**Please note:** The plugin requires the *Genesis Theme Framework* (GPL-2.0+), a paid premium product released by StudioPress/ Rainmaker Digital LLC (former Copyblogger Media) (via studiopress.com).

**WordPress 4.6+ Info** If you update to WordPress 4.6 or higher, please make sure, you update BEFORE to Genesis 2.3.1 or higher! Otherwise you'll get error -- this has nothing to do with our plugin only with base Genesis but we want you to have safe update procedure of course. Layout extras plugin has been tested compat with WP 4.6.
...
**NOTE:** Only works with *Genesis Framework* (GPL-2.0+) as the parent theme. This is a paid premium product by StudioPress/ Rainmaker Digital LLC (former Copyblogger Media), available via studiopress.com.
...
* NEW: Added new French translation by [Grégoire Noyelle](http://www.gregoirenoyelle.com/)

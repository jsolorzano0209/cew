...
if ( ! class_exists( 'NgfbSubmenuDashboard' ) && class_exists( 'NgfbAdmin' ) ) {

	class NgfbSubmenuDashboard extends NgfbAdmin {
		...
		protected function add_meta_boxes() {
			...
			$ids = array( 
				...
				// second row
				'status_gpl' => _x( 'Free / Standard Features', 'metabox title', 'nextgen-facebook' ),
				'status_pro' => _x( 'Pro / Additional Features', 'metabox title', 'nextgen-facebook' ),
			);

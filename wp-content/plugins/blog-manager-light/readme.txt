...
Add tons of blog functionality to your WordPress based website. 
...
Check on the Blog Manager Light:  [Demo site](http://otwthemes.com/demos/1ts/?item=Blog%20Manager%20Light&utm_source=wp.org&utm_medium=page&utm_content=demo&utm_campaign=bm) | [Documentation page](http://otwthemes.com/online-documentation-blog-manager-light/?utm_source=wp.org&utm_medium=page&utm_content=docs&utm_campaign=bm)
...
>  
> [Blog Manager](http://codecanyon.net/item/blog-manager-for-wordpress/9982292?ref=OTWthemes&utm_source=wp.org&utm_medium=page&utm_content=upgrade&utm_campaign=bm) |
> [Demo site](http://otwthemes.com/demos/1ts/redirect.php?item=Blog%20Manager&utm_source=wp.org&utm_medium=page&utm_content=upgrade&utm_campaign=bm) 
...
Please refer to [online documentation page](http://otwthemes.com/online-documentation-blog-manager-light/?utm_source=wp.org&utm_medium=page&utm_content=docs&utm_campaign=bm) for more details.
...
1. Templates and post selection
2. List elements and order
3. Posts order and limits
4. More options

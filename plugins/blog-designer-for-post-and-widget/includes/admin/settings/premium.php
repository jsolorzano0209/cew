...
<div class="wrap">
	...
	<h2><?php _e( 'Blog Designer - Features', 'blog-designer-for-post-and-widget' ); ?></h2><br />

	<div class="bdpw-notice">
		<a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=4892&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade</a> a plugin within a minute and unloack many features now!!!
	</div>
	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><a href="https://www.wponlinesupport.com/checkout/?edd_action=add_to_cart&download_id=4892&edd_options[price_id]=3&ref=wposthemeplugin" target="_blank">Upgrade Now</a></td>
	    	</tr>
	    </tfoot>
	    ...
	    <tbody>
	    	...
	    	<tr>
		    	...
		    	<td>2 - ( Post Grid , Post Slider )</td>
	    		<td>8 - ( Grid , Recent Post , Slider , GridBox , GridBox Slider , List , Masonry , Ticker )</td>
	    	</tr>
			<tr>

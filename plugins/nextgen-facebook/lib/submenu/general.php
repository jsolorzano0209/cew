		...
		protected function get_table_rows( $metabox_id, $key ) {
			...
			switch ( $metabox_id.'-'.$key ) {
				...
				case 'og-text':
					...
					$table_rows['og_title_len'] = $this->form->get_th_html( _x( 'Maximum Title Length',
					...
					$table_rows['og_desc_len'] = $this->form->get_th_html( _x( 'Maximum Description Length',
					...
					$table_rows['og_desc_hashtags'] = '<tr class="hide_in_basic">'.
					$this->form->get_th_html( _x( 'Add Hashtags to Descriptions',
				...
				case 'pub-facebook':
					...
					$table_rows['fb_admins'] = '<tr class="hide_in_basic">'.
					$this->form->get_th_html( _x( 'or Facebook Admin Username(s)',
				...
				case 'pub-google':
					...
					$noscript_comment_transl = _x( 'option disabled by add-on plugin or custom filter', 'option comment', 'nextgen-facebook' );
					...
					if ( ! $noscript_disabled ) {
						...
						$this->form->get_th_html( _x( 'Meta Property Containers',
							'option label', 'nextgen-facebook' ), '', 'schema_add_noscript' ).

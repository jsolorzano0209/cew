	...
	class NgfbScript {
		...
		public function admin_enqueue_scripts( $hook_name ) {
			...
			wp_register_script( 'sucom-admin-media', 
				NGFB_URLPATH.'js/com/jquery-admin-media.min.js', 
		...
		public function get_admin_media_script_data() {
			return array(
				'choose_image' => __( 'Use Image', 'nextgen-facebook' ),
			);
		}
		 ...
		 * used by NgfbAdmin class filters to return the user back to the settings page after

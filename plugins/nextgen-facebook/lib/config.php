...
if ( ! class_exists( 'NgfbConfig' ) ) {
	...
	class NgfbConfig {
		...
		public static $cf = array(
			...
			'plugin' => array(
				'ngfb' => array(			// Plugin acronym.
					'version' => '8.50.1',		// Plugin version.
				...
				'ngfbum' => array(			// Plugin acronym.
					'short' => 'NGFB UM',		// Short plugin name.
					'name' => 'NextGEN Facebook Update Manager',
					'desc' => 'NextGEN Facebook add-on to provide updates for the NextGEN Facebook Pro plugin.',
		...
		public static function get_variable_constants() {
			...
			$var_const['NGFB_CONTENT_IMAGES_MAX_LIMIT'] = 5;		// maximum number of images extracted from the content
			$var_const['NGFB_CONTENT_VIDEOS_MAX_LIMIT'] = 5;		// maximum number of videos extracted from the content
			...
			$var_const['NGFB_DUPE_CHECK_WARNING_TIME'] = 2.50;		// issue a warning if getting shortlink took more than 2.5 seconds
			$var_const['NGFB_DUPE_CHECK_TIMEOUT_TIME'] = 3.00;		// hard-limit - most crawlers time-out after 3 seconds

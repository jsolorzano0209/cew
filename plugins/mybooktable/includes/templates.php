...
function mbt_get_book_archive_title($before = '', $after = '') {
	...
	if(is_tax('mbt_author')) {
		$output = '<span class="mbt-archive-taxonomy-title">'.__('Author', 'mybooktable').':</span> '.get_queried_object()->name;
	} else if(is_tax('mbt_genre')) {
		$output = '<span class="mbt-archive-taxonomy-title">'.__('Genre', 'mybooktable').':</span> '.get_queried_object()->name;
	} else if(is_tax('mbt_series')) {
		$output = '<span class="mbt-archive-taxonomy-title">'.__('Series', 'mybooktable').':</span> '.get_queried_object()->name;
	} else if(is_tax('mbt_tag')) {
		$output = '<span class="mbt-archive-taxonomy-title">'.__('Tag', 'mybooktable').':</span> '.get_queried_object()->name;
